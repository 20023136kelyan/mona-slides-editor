...
export function ShapeStylePanel({
  ...
  return (
    <div className="mona-shape-style-panel">
      ...
      {fillType === 'gradient' ? (
        <>
          <div className="mona-panel-row-full"><GradientBar index={gradientIndex} onChange={colors => updateGradient({ colors })} onIndexChange={setGradientIndex} value={gradient.colors} /></div>
      ...
      {element.text?.content ? (
        <>
          ...
          <div className="mona-panel-divider" />
          <div className="mona-panel-split-row is-insets"><InspectorNumberInput ariaLabel={t('foundation.editor.text.marginTop')} label={t('foundation.editor.text.marginTop')} max={50} min={0} onChange={value => updateInset(0, value)} value={inset[0]} /><InspectorNumberInput ariaLabel={t('foundation.editor.text.marginBottom')} label={t('foundation.editor.text.marginBottom')} max={50} min={0} onChange={value => updateInset(2, value)} value={inset[2]} /></div>
          <div className="mona-panel-split-row is-insets"><InspectorNumberInput ariaLabel={t('foundation.editor.text.marginLeft')} label={t('foundation.editor.text.marginLeft')} max={50} min={0} onChange={value => updateInset(3, value)} value={inset[3]} /><InspectorNumberInput ariaLabel={t('foundation.editor.text.marginRight')} label={t('foundation.editor.text.marginRight')} max={50} min={0} onChange={value => updateInset(1, value)} value={inset[1]} /></div>
          <div className="mona-panel-divider" />
