...
export const createGate2Theme = (): SlideTheme => ({
...
export const createGate2Presentation = (): PresentationState => ({
  title: 'Gate 2 fixture',
  theme: createGate2Theme(),
  slides: [
    {
      id: 'fixture-slide-1',
      elements: [
...
export interface Gate2OperationScenario {
  name: string
  command: PresentationCommand
}

export const createGate2OperationScenarios = (): Gate2OperationScenario[] => {
...
export const createLargeGate2Presentation = (
