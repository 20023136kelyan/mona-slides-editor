...
/**
 * Resolves an OPC relationship target against the owning package part.
 *
 * OOXML permits both package-absolute targets (`/ppt/charts/chart1.xml`) and
 * relative targets (`../charts/chart1.xml`). Treating absolute targets as
 * relative silently loses otherwise valid charts, media, layouts, and themes.
 */
export function resolvePackageTarget(sourcePart, target) {
  if (!target) return ''
