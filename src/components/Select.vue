  ...
  >
    <template #content>
      <template v-if="search">
        <Input ref="searchInputRef" simple :placeholder="resolvedSearchLabel" v-model:value="searchKey" :style="{ width: width + 2 + 'px' }" />
        <Divider :margin="0" />
      </template>
...
const resolvedSearchLabel = computed(() => props.searchLabel || t('common.search'))
