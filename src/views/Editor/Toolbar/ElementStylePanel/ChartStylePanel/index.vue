<template>
  <div class="chart-style-panel">
    <Button class="full-width-btn" @click="openDataEditor()">
      <i-icon-park-outline:edit /> {{ $t('elementStyle.editChart') }}
    </Button>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('elementStyle.chartBackground') }}</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('elementStyle.axisAndText') }}</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('elementStyle.gridColor') }}</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('elementStyle.chartTheme') }}</div>
      <Popover trigger="click" v-model:value="themesVisible" style="width: 60%;">
        <template #content>
          <div class="themes">
            <div class="label">{{ $t('elementStyle.presetChartThemes') }}</div>
            ...
            <div class="label">{{ $t('elementStyle.slideTheme') }}</div>
            ...
            <Divider :margin="10" />
            <Button class="full-width-btn" @click="themesVisible = false; themeColorsSettingVisible = true">{{ $t('elementStyle.customColors') }}</Button>
          </div>
        </template>
