<template>
  <div class="latex-style-panel">
    <div class="row">
      <Button style="flex: 1;" @click="openLatexEditor()"><i-icon-park-outline:edit /> {{ $t('latexEditor.edit') }}</Button>
    </div>

    <Divider />

    <div class="row">
      <div style="width: 40%;">{{ $t('common.color') }}:</div>
    ...
    <div class="row">
      <div style="width: 40%;">{{ $t('elementStyle.weight') }}</div>
      <NumberInput 
        :min="1"
        :max="3"
