<template>
  ...
  >
    <div class="header">
      <span class="text-btn" @click="toggle()">{{ inTiming ? $t('timer.pause') : $t('timer.start') }}</span>
      <span class="text-btn" @click="reset()">{{ $t('common.reset') }}</span>
      <span class="text-btn" @click="toggleCountdown()" :class="{ 'active': isCountdown }">{{ $t('timer.countdown') }}</span>
    </div>
    <div class="content">
      <div class="timer">
        <input 
